...
converted_for: vizguide guideline
---

# BBC Visual and Data Journalism cookbook for R graphics

#### _Last updated: 2019-01-24_
...
For more info on `bbplot` check out the package’s Github repo, but most of the details about how to use the package and its functions are detailed below.
